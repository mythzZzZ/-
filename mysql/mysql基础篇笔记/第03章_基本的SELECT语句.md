...
- 举例
  ...
  select 别名用双引号，insert内容时， insert into emp values(1002,'TOM') 此时用单引号
...
==多个查询字段，前面有DISTINCT，此时是对字段组合进行DISTINCT==

![image-20231107102054803](https://zhangwenkang666.oss-cn-beijing.aliyuncs.com/image-20231107102054803.png)
...
![image-20231107102957102](https://zhangwenkang666.oss-cn-beijing.aliyuncs.com/image-20231107102957102.png)
